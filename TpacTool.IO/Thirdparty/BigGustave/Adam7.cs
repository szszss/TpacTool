...
namespace TpacTool.IO
{
    ...
    internal static class Adam7
    {
        ...
        /// </summary>
        private static readonly Dictionary<int, int[]> PassToScanlineGridIndex = new Dictionary<int, int[]>
        {
            { 1, new []{ 0 } },
            { 2, new []{ 0 } },
            { 3, new []{ 4 } },
        ...
        private static readonly Dictionary<int, int[]> PassToScanlineColumnIndex = new Dictionary<int, int[]>
        {
            { 1, new []{ 0 } },
            { 2, new []{ 4 } },
            { 3, new []{ 0, 4 } },
        ...
        public static Location GetPixelIndexForScanlineInPass(ImageHeader header, int pass, int scanlineIndex, int indexInScanline)
        {
            ...
            return new Location(precedingCols + columnIndices[actualCol], precedingRows + rows[actualRow]);
        }
